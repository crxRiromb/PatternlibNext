...
import type { PlItemlist } from '../pl-itemlist.ts';
import '../pl-itemlist.ts';
...
const meta: Meta = {
  ...
  argTypes: {
    ...
    data: {
      control: 'object',
      description: 'Array of items to display in the format [{key: string, value: string}, ...]',
    },
  },
};
...
export const DefaultStory: Story = {
  ...
  render: args => html` <pl-itemlist headline-label=${args.headlineLabel} .data=${args.data}></pl-itemlist> `,
};
